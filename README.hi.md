...
## v1.7.0 में नया क्या है

v1.7 पूरे गेम को इंजन 3.9 पर ले जाता है — एक ही अपडेट में दस छोटे संस्करण, और पहले से सहेजे गए सभी गेम अभी भी लोड होते हैं — और नए इंटरफ़ेस का उपयोग उन चीज़ों पर किया जाता है जो आपको गेम खेलते समय महसूस होती हैं।

| सुविधा | इसका क्या मतलब है |
|---------|--------------|
| **Twelve playable worlds** | सॉल्ट रोड लेजर (एक व्यापारी अभियान जिसमें हर ऋण एक चाकू है) और ह्यू एंड क्राई (एक ऐसे शहर में चोर पकड़ने वाला, जहाँ कोई पुलिस बल नहीं है) गेम में शामिल होते हैं — बारह दुनिया, जिन्हें कठिनाई के आधार पर समूहीकृत किया गया है। |
| **Engine 3.9 under the hood** | एक व्यवहार-संरक्षण अपडेट में दस छोटे इंजन संस्करणों को अपनाया गया। अपडेट से पहले सहेजे गए गेम, हर नए सबसिस्टम के साथ लोड होते हैं, और कभी भी हटाए नहीं जाते। |
| **`quit` ऑटो-सेव** | `quit` टाइप करने पर अब गेम बंद करने से पहले सहेजता है, ठीक उसी तरह जैसे Ctrl+C हमेशा करता था — और अंततः डेथ स्क्रीन इसके बारे में सच्चाई बताती है। |
| **एनपीसी (गैर-खिलाड़ी पात्र) ध्यान देते हैं कि आपके साथ कौन है** | संवाद में लाइव पार्टी की उपस्थिति, खुले अवसर, दुनिया का दबाव और क्षेत्र की बनावट शामिल है — सराय का मालिक आपके साथी को नाम से अभिवादन कर सकता है और उस सौदे पर जोर दे सकता है जिसे आपने टेबल पर छोड़ दिया था। |
| **लड़ाई में साथी महत्वपूर्ण हैं** | भर्ती किए गए सहयोगी अब अपने इंजन-आधारित भूमिका टैग और साझा गुट को रखते हैं: लड़ाकू आपके लिए हस्तक्षेप करते हैं, और आपकी तरफ से किसी को भी अब दुश्मन के रूप में लक्षित नहीं किया जाता है। |
| **The strategic read** | जब दुनिया आपके खिलाफ हो जाती है, तो वर्णन इंजन की अपनी स्थिति को दर्शाता है — दबाव जो आप गेम में महसूस कर सकते हैं, इससे पहले कि आप मानचित्र खोलें। |
| **1,870 परीक्षण** | 98 फ़ाइलों में 1,542 से बढ़कर, जिसमें चार-चरणीय स्वास्थ्य पास (149 निष्कर्ष दर्ज किए गए, 136 ठीक किए गए) शामिल हैं। |
