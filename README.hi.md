...
## v2.0.0 में नया क्या है

v2.0 एक जीवंत-दुनिया संस्करण है: दुनिया इंजन की अपनी गति से चलती है, सड़क आपके कार्यों पर प्रतिक्रिया करती है, और आपके द्वारा पहले लिखी गई हर सहेजी गई फ़ाइल अभी भी लोड होती है।

| सुविधा | इसका क्या मतलब है |
|---------|--------------|
| **दुनिया अपनी गति से चलती है** | उत्पन्न दुनिया में शुरुआती पैकों के समान पूर्ण मॉड्यूल परिवार होता है, इंजन की अपनी गति दबाव, अवसरों, मुठभेड़ों और गुटों की गतिविधियों को चलाती है, और प्रत्येक सत्र का डेटा दुनिया की सच्चाई का प्रतिनिधित्व करता है। |
| **Enemies act** | एक जागरूक शत्रु हमले से ठीक पहले अपनी योजना बताता है; कथन के ऊपर एक आरक्षित युद्ध चैनल आपके परिणाम, मारे गए लोगों, किए गए हमलों और आगे क्या होगा, यह बताता है। |
| **Asks and recognition** | सहायता की आवश्यकता वाले याचिकाकर्ता, और ऐसे धोखेबाज जो बिल्कुल उनके जैसे दिखते हैं - संकेत दिए जाते हैं, और बाद में एक निश्चित कीमत पर सच्चाई सामने आती है। वास्तविक व्यक्ति की मदद करें और उसी दौर में यह बात सामने आ जाती है; खड़े रहने पर, एक अफवाह, बाद में मिलने वाली कृतज्ञता, और एक सम्मानजनक प्रतिक्रिया। |
| **The street answers you** | अज्ञात स्लैश कमांड का तुरंत उत्तर दिया जाता है, बिना किसी मोड़ खर्च किए; एनपीसी को टाइप की गई एक पंक्ति भाषण होती है; केवल नाम बोलने पर, और केवल बाहर निकलने पर, वह बाहर निकल जाता है; `/go <exit>` और `/rumors` प्ले मोड में काम करते हैं; एक उद्धृत बाजार मूल्य स्थान ब्लॉक में रहता है। |
| **Rumors with a stance** | एनपीसी अफवाहें सुनते हैं, वे या तो उन पर विश्वास करते हैं या संदेह करते हैं, और अफवाहें आस-पास के जिलों में फैल जाती हैं - दोनों को एक मापी गई शीट पर ट्यून किया जाता है। |
| **A tuning surface** | प्रत्येक जीवंत-दुनिया तत्व एक मापी गई डिफ़ॉल्ट सेटिंग पर होता है, `/tuning` इसे पढ़ने के लिए, और सभी तेरह दुनियाओं पर एक नियतात्मक 30-मोड़ मैट्रिक्स। उस शीट पर दुश्मन के नुकसान को 0.5 पर ट्यून किया गया था। |
| **Save schema v3** | अफवाह इंजन सहेजे गए डेटा का उपयोग करता है, प्रत्येक 1.x सहेजा गया डेटा पूर्ण-विश्वसनीयता प्रमाणों के साथ माइग्रेट होता है, और उत्पन्न दुनिया वहीं से फिर से शुरू होती है जहां वह रुकी थी। |
| **पांच मॉडल परिवारों द्वारा खेला गया** | चार एआई परिवार प्लेटेस्ट (मिस्ट्रल, क्वेन, लामा, डीपसीक, जेमिनी सीटें, प्रत्येक 40 मोड़) ने मानव मूल्यांकन को बदल दिया और अंतिम दो लहरों को आकार दिया। |
| **2,495 परीक्षण** | 121 फ़ाइलों में 1,870 से बढ़कर, प्रत्येक लहर एक परिवार-विविध जूरी और एक नियतात्मक आधार के माध्यम से पूरी हुई। |
...
|---------|-------------|
| [AI RPG Engine](https://github.com/mcp-tool-shop-org/ai-rpg-engine) | निर्धारित सिमुलेशन रनटाइम — पूर्ण जीवित-दुनिया मॉड्यूल स्टैक, शून्य एलएलएम निर्भरता |
